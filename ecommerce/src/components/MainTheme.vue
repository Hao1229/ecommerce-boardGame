          ...
          <div class="col-md-3">
            <div class="text-center mb-3 mb-md-0" style="position:sticky;top:80px;">
              ...
              <ul class="list-group list-group-flush mt-3 d-none d-md-block">
                ...
                <li class="list-group-item list-group-item-action pointer active">主題遊戲</li>
              </ul>
              <span class="h4 d-inline d-md-none text-primary">主題遊戲</span>
            </div>
          </div>
